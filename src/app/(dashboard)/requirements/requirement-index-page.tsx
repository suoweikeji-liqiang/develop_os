...
// Primary location: this file now owns the Requirement list surfaces.
// `/explorations` remains a legacy alias that forwards here.
export async function RequirementIndexPage({ listView }: Props) {
  await verifySession()
  ...
  return (
    <div className="space-y-8">
      ...
      <RequirementsListClient initialRequirements={serialized} initialView={listView} />
    </div>
  )
}
