      ...
      const clarificationConclusions = clarificationIssueUnits
        .map((issue) => {
          ...
          return {
            ...
            sinkDetailLabel: conclusionSignal.sinkDetailLabel,
            sinkDetailSummary: conclusionSignal.sinkDetailSummary,
      ...
      return {
        ...
        impactSummary: buildRequirementImpactSummary({
          ...
          clarificationConclusions: clarificationConclusions.map((item) => ({
            ...
            sinkDetailLabel: item.sinkDetailLabel,
            sinkDetailSummary: item.sinkDetailSummary,
